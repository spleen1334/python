...
class ScrapySpider(Spider):
    """
    Similar to selenium but using pure scrapy
    """
    name = 'scrapy'
    allowed_domains = ['books.toscrape.com']
    # start_urls = ['http://books.toscrape.com']

    # Run this spider on terminal from provided url
    # scrapy crawl scrapy -a url="http://books.toscrape.com/catalogue/category/books/philosophy_7/index.html"
    ...
    def close(self, reason):
        """
        Run code from here when scrapy finishes with crawling
        """
